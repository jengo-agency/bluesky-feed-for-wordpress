...
class Bluesky_Feed {
    ...
    public function register_settings() {
        ...
        register_setting('bluesky_settings_group', 'bluesky_scrollable_widget', ['default' => 0, 'sanitize_callback' => 'absint']);
        register_setting('bluesky_settings_group', 'bluesky_scrollable_height', ['default' => 400, 'sanitize_callback' => 'absint']);
    }
    ...
    public function render_settings_page() {
        ...
        $scrollable_widget = absint(get_option('bluesky_scrollable_widget', 0));
        $scrollable_height = absint(get_option('bluesky_scrollable_height', 400));
?>
        <div class="wrap">
            <h1>
            ...
            <form method="post" action="options.php">
                ...
                <table class="form-table">
                    ...
                    <tr>
                        <th><?php esc_html_e('Scrollable Widget', 'bluesky-feed'); ?></th>
                        <td>
                            <input
                                type="checkbox"
                                name="bluesky_scrollable_widget"
                                value="1"
                                <?php checked($scrollable_widget, 1); ?>>
                            <p class="description"><?php esc_html_e('Enable scrollable widget with fixed height', 'bluesky-feed'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th><?php esc_html_e('Scrollable Widget Height', 'bluesky-feed'); ?></th>
                        <td>
                            <input
                                type="number"
                                name="bluesky_scrollable_height"
                                value="<?php echo esc_attr($scrollable_height); ?>"
                                min="200"
                                max="1000">
                            <p class="description"><?php esc_html_e('Height in pixels for the scrollable widget', 'bluesky-feed'); ?></p>
                        </td>
                    </tr>
                </table>
                <?php submit_button(); ?>
